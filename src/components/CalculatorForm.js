    ...
    return `<div>
      ...
      <form class="counter__form form" name="counter" action="#" method="post">
        ...
        <div class="form__submit">
          <button class="form__submit-button button" name="submit" type="submit">
            Рассчитать
          </button>
          <button class="form__reset-button" name="reset" type="reset">
  ...
  _getInputValues() {
    ...
    this._inputsList.forEach((input) => {
      if (input.type.toLowerCase() === "radio") {
        input.checked && (this._formValues[input.name] = input.value);
      } else {
